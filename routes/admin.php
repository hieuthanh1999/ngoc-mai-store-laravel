...
Route::middleware(['auth.admin', 'admin.verified'])->group(function () {
    ...
    Route::group(['prefix' => 'banners'], function(){
        Route::get('/', [BannerController::class, "index"])->name('admin.banners_index');
        Route::get('create', [BannerController::class, "create"])->name('admin.banners_create');
        Route::post('create', [BannerController::class, "store"])->name('admin.banners_store');
        Route::get('edit/{id}', [BannerController::class, "edit"])->name('admin.banners_edit');
        Route::post('update/{id}', [BannerController::class, "update"])->name('admin.banners_update');
        Route::post('delete', [BannerController::class, "delete"])->name('admin.banners_delete');
    });

    Route::group(['prefix' => 'news'], function(){
        Route::get('/', [NewsController::class, "index"])->name('admin.news_index');
        Route::get('create', [NewsController::class, "create"])->name('admin.news_create');
        Route::post('create', [NewsController::class, "store"])->name('admin.news_store');
        Route::get('edit/{id}', [NewsController::class, "edit"])->name('admin.news_edit');
        Route::post('update/{id}', [NewsController::class, "update"])->name('admin.news_update');
        Route::post('delete', [NewsController::class, "delete"])->name('admin.news_delete');
    });
