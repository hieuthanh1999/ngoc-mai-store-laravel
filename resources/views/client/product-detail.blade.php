                    ...
                    <div class="products-details">
                        <div class="preview_image">
                            <div class="preview-small text-center">
                                <img id="zoom_03" src="{{ asset('asset/client/images/products/small/' . $product->img) }}"
                                    data-zoom-image="{{ asset('asset/client/images/products/small/' . $product->img) }}"
                                    alt="">
                            </div>
                                    ...
                                    @foreach ($productColor as $color)
                                        <li class="sub-img">
                                            <a href="#" class="thumbnail"
                                                data-image="{{ asset('asset/client/images/products/small/' . $color->img) }}"
                                                data-zoom-image="{{ asset('asset/client/images/products/small/' . $color->img) }}">
                                        ...
                                        <div class="col-md-3 col-sm-4">
                                            <div class="products">
                                                <div class="thumbnail text-center">
                                                    <img src="{{ asset("asset/client/images/products/small/$relatedProduct->img") }}"
                                                        alt="Product Name">
                                                </div>
                                                ...
                                                <div class="productname" style="padding-bottom: 10px; padding-top: unset;">
                                                    ...
                                                    <span style="font-size: 14px;">Đã bán:
                                                        {{ $relatedProduct->sum }}</span>
                                                </div>
                                                <div class="button_group">
                                                    <a href="{{ route('user.products_detail', $relatedProduct->id) }}"
                                                        class="button add-cart" type="button">Xem Chi Tiết</a>
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-sm-6">
                                                <div class="form-row row">
                                                    <div class="col-md-5">
                                                        <label class="title-avg-star review-lable">Đánh giá trung
                                                            bình</label>
                                                        <div class="avg-star">
                                                        ...
                                                        <h4 class="number-avg-star">{{ number_format($avgRating, 1) }}
                                                        </h4>
                                                    </div>
                                                    <div class="col-md-6">
                                                        ...
                                                        @for ($i = 5; $i >= 1; $i--)
                                                            <div class="avg-star">
                                                                <x-stars :number="$i" />
                                                                <span
                                                                    class="parameter-review">({{ $ratingStatistics[$i] }})</span>
                                                            </div>
                                                        @endfor
                                                    </div>
                                                </div>
